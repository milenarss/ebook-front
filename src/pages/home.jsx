      ...
      <div className="w-[100%]">
          ...
          <div className="w-full h-3/4 bg-white flex justify-center rounded-t-3xl">
            <div className="w-5/6 h-full flex flex-col items-center justify-center">
              <div className="w-full h-5/6">
                <h1 className="font-bold text-[#334333] italic text-2xl">
                  SOBRE O APLICATIVO
                </h1>
                <p className="text-[#334333] text-lg pt-5">
                  O aplicativo Descarte Consciente tem o intuito de
                  conscientizar e te ajudar a realizar o descarte correto, além
                  de interagir com o usuário.
                </p>
                <p className="text-[#334333] text-lg pt-5">
                  Este vem sendo desenvolvido pelos alunos do curdo de Análise e
                  desenvolvimento de sistemas, na faculdade Unisal.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="w-full h-screen bg-[url('src/assets/fundoHome.png')] bg-no-repeat bg-cover flex items-center justify-center">
          <div className="bg-white w-4/5 h-[55%] rounded-3xl flex flex-col justify-evenly">
            <IconeTexto
              imagem={iconFolha}
              texto={"Faça sua contribuição para o mundo."}
            />
            <IconeTexto
              imagem={iconLixeira}
              texto={"Realize o descarte da forma correta."}
            />
            <IconeTexto
              imagem={iconMapa}
              texto={"Econtre o ecoponto mais próximo da sua casa."}
            />
          </div>
        </div>
            ...
            <div className="w-hull h-5/6 flex flex-col items-center justify-center">
              <div className="flex flex-col justify-end items-center w-full h-1/2">
                <h1 className="font-bold text-white text-xl">
                  Deseja conhecer melhor o projeto?
                </h1>
                <p className="text-white pt-5 text-lg">
                  Explore as funcionalidades interativas clicando no botão
                  abaixo:
                </p>
              </div>

              <div className="flex flex-col justify-evenly items-center w-full h-1/2 ">
                <BotaoPrincipal textoBotao={"EXPLORAR"} funcao={irMenu} />
              </div>
            </div>
